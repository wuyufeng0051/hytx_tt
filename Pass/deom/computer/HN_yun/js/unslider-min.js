...
function($) {
    return $ ? ($.Unslider = function(t, n) {
        ...
        e.stop = function() {
            return clearTimeout(e.interval),
            e
        },
        e.initNav = function() {
            ...
            e.$slides.each(function(n) {
                ...
                t.children("ol").append('<li data-slide="' + n + '"><span><i></i></span></li>')
            }),
            e.$nav = t.insertAfter(e.$context),
            e.$nav.find("li").on("click" + e.eventSuffix,
            function() {
        ...
        e.initKeys = function() {
            ...
            $(document).on("keyup" + e.eventSuffix,
            function(t) {
                $.each(e.options.keys,
                function(n, i) {
        ...
        e.animate = function(t, n) {
            ...
            return $.isFunction(e[i]) && e[i](e.current, n),
            e
        },
        e.next = function() {
            var t = e.current + 1;
            return t >= e.total && (t = 0),
            e.animate(t, "next")
        },
        e.prev = function() {
        ...
        e.animateVertical = function(t) {
            return e.options.animateHeight = !0,
            e.options.infinite && e.$container.css("margin-top", -e.$slides.outerHeight()),
            e.slide("top", t)
        },
        e.slide = function(t, n) {
            ...
            !1), e.options.infinite) {
                ...
                "number" == typeof i && (e.setIndex(i), e.$context.on(e._ + ".moved",
                function() {
    ...
    $.fn._active = function(t) {    
        return this.addClass(t).siblings().removeClass(t),(
	        this.find("video").trigger('play'),(
                this.closest('.showed').siblings().find("video").trigger('pause')
            )
    	)
    },
    $._ucfirst = function(t) {
