			...
			'success' : function(result){
				...
				if(result && result['success'] == 1){
					...
					if(result['data'].length > 0){
						...
						$('#pages').hide();
						img = '<div style="margin-top:200px;height:80px;text-align:center;font-size:20px;font-weight:bold;">暂时没有图片</div>';
...
var strVar = "";
    ...
    strVar += "										<input name='img_keyword' value=\"\" placeholder=\"请输入图片名\" class=\"nav-search-input\" type=\"text\">";
    ...
    strVar += "				";
    strVar += "			        <span id=\"ensure\" class=\"upload-btn upload-btn_default oper_ele l js_popover\">确定<\/span>";
    strVar += "			        <span id=\"cancel\" class=\"upload-btn upload-btn_default oper_ele l js_popover\">取消<\/span>";
    strVar += "				";
    strVar += "				<\/div>";
    strVar += "		       ";
    strVar += "";
