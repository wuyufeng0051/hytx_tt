...
var curYear=YMD.substring(0,6).substring(0,4);
var curMonth=YMD.substring(0,6).substring(4,6)*1;
jQuery("select#mYear").val(curYear);
jQuery("select#mMonth").val(curMonth+"");
