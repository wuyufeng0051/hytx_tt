...
loadJsFileToTop(["$js_path$webp/com/kits/qmeditor/qqmail/release/editor33e2a0.js"]);
...
{
cacheByIframe(a&&a.defcss==false?[]:[["css","",getRes("$css_path$webp/comm327bfb.css")],["css",getPath("style"),"skin"]],extend({className:"menu_base_if",transparent:false,destroy:false},a,{win:b,header:["<script>",getTop.toString().replace(/[\r\n]/g,""),"<\/script>",a&&a.header||""].join(""),onload:function(c){
...
if(!b.QMPlayer)
{
loadJsFileToTop(["$js_path$webp/qmplayer/player32be95.js"]);
}
waitFor(function(){
return !!b.QMPlayer;
},function(c){
...
var a={'comm2010.css':'$css_path$webp/comm2010327bfb.css'};
return function(b){
var c=a[b];
return c&&getRes(c);
};
