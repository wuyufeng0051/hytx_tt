...
$(function(){
    ...
    $('.click_more strong').text(more_options);
	...
	$('.no_bt').click(function(){
		...
		$(this).parents('.brand_img').find(".choose_more").html("<i class='icon'></i>"+multi_select);
    });
    ...
    choose_more.click(function(){
		...
		function slext(){
			...
			if(slExt.hasClass("down")){
				...
				$this.html("<i class='icon'></i>"+multi_select);
				...
				slExt.addClass("down");
				$this.html("<i class='icon'></i>"+Pack_up);
				...
				li.siblings().find(".choose_more").html("<i class='icon'></i>"+multi_select);
			}
		}
	...
	no_btn.click(function(){
		...
		attr_list.find(".choose_more").html("<i class='icon'></i>"+multi_select);
	});
