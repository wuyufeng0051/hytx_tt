...
var calUtil = {
  ...
  drawCal : function(iYear,iMonth ,signList ,RetroList, SpecialList) {
   ...
   htmls.push("<tr>");
   htmls.push("<th>星期" + myMonth[0][0] + "</th>");
   htmls.push("<th>星期" + myMonth[0][1] + "</th>");
   htmls.push("<th>星期" + myMonth[0][2] + "</th>");
   htmls.push("<th>星期" + myMonth[0][3] + "</th>");
   htmls.push("<th>星期" + myMonth[0][4] + "</th>");
   htmls.push("<th>星期" + myMonth[0][5] + "</th>");
   htmls.push("<th>星期" + myMonth[0][6] + "</th>");
   htmls.push("</tr>");
   var d, w;
