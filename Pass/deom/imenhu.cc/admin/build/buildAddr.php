 ...
 * 管理建材地区
 *
 * @version        $Id: buildAddr.php 2013-11-6 上午11:06:10 $
...
checkPurview("buildAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/build";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "buildAddr.html";
