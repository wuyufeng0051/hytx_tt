 ...
 * 建材频道配置
 *
 * @version        $Id: buildConfig.php 2014-2-28 上午11:01:52 $
...
checkPurview("buildConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/build";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "buildConfig.html";
