 ...
 * 建材留言
 *
 * @version        $Id: buildGuest.php 2014-3-1 下午20:53:10 $
...
checkPurview("buildGuest");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/build";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "buildGuest.html";
...
if($dopost == "getDetail"){
	...
	if(count($results) > 0){
		...
		$archives = $dsql->SetQuery("SELECT `company` FROM `#@__build_store` WHERE `id` = ".$results[0]["company"]);
