 ...
 * 建材资讯分类
 *
 * @version        $Id: buildNewsType.php 2016-6-19 下午19:04:10 $
...
checkPurview("buildNewsType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/build";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "buildNewsType.html";
...
//修改分类
	...
	if(!testPurview("editBuildNewsType")){
...
//删除分类
	...
	if(!testPurview("delBuildNewsType")){
		die('{"state": 200, "info": '.json_encode('对不起，您无权使用此功能！').'}');
	}
	if($id == "") die;
...
//更新信息分类
	...
	if(!testPurview("addBuildNewsType")){
		die('{"state": 200, "info": '.json_encode('对不起，您无权使用此功能！').'}');
	}
