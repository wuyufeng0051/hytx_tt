 ...
 * 模板标记
 *
 * @version        $Id: mytag.php 2014-5-11 下午21:36:15 $
...
if($submit == "预览"){
	...
	$handels = new handlers($action, "blist");
...
//新增标记
	...
	if($submit == "提交"){
		...
		$archives = $dsql->SetQuery("INSERT INTO `#@__mytag` (`name`, `module`, `type`, `start`, `end`, `config`, `expbody`, `state`, `pubdate`) VALUES ('$name', '$action', 'blist', '$start', '$end', '$data', '$expbody', '$state', '".GetMkTime(time())."')");
