 ...
 * 管理汽车区域
 *
 * @version        $Id: carAddr.php 2014-7-18 下午17:24:21 $
 * @package        HuoNiao.Car
...
checkPurview("carAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/car";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "carAddr.html";
