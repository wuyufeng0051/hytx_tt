 ...
 * 汽车频道配置
 *
 * @version        $Id: carConfig.php 2014-8-20 下午16:15:24 $
 * @package        HuoNiao.Car
...
checkPurview("carConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/car";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "carConfig.html";
