 ...
 * 管理家具地区
 *
 * @version        $Id: furnitureAddr.php 2013-11-6 上午11:06:10 $
...
checkPurview("furnitureAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/furniture";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "furnitureAddr.html";
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'admin/furniture/furnitureAddr.js'
	);
