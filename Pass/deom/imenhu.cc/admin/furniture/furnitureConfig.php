 ...
 * 家具频道配置
 *
 * @version        $Id: furnitureConfig.php 2014-2-28 上午11:01:52 $
...
checkPurview("furnitureConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/furniture";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "furnitureConfig.html";

$action =  $action == "" ? "furniture" : $action;
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'publicUpload.js',
		'admin/furniture/furnitureConfig.js'
	);
