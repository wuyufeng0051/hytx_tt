 ...
 * 家具资讯分类
 *
 * @version        $Id: furnitureNewsType.php 2016-6-19 下午19:04:10 $
...
checkPurview("furnitureNewsType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/furniture";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "furnitureNewsType.html";

$action = "furniture_news";
...
//修改分类
	...
	if(!testPurview("editFurnitureNewsType")){
...
//删除分类
	...
	if(!testPurview("delFurnitureNewsType")){
		die('{"state": 200, "info": '.json_encode('对不起，您无权使用此功能！').'}');
	}
	if($id == "") die;
...
//更新信息分类
	...
	if(!testPurview("addFurnitureNewsType")){
		die('{"state": 200, "info": '.json_encode('对不起，您无权使用此功能！').'}');
	}
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'admin/furniture/furnitureNewsType.js'
	);
