 ...
 * 管理家居地区
 *
 * @version        $Id: homeAddr.php 2013-11-6 上午11:06:10 $
...
checkPurview("homeAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/home";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "homeAddr.html";
