 ...
 * 家居留言
 *
 * @version        $Id: homeGuest.php 2014-3-1 下午20:53:10 $
...
checkPurview("homeGuest");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/home";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "homeGuest.html";
...
if($dopost == "getDetail"){
	...
	if(count($results) > 0){
		...
		$archives = $dsql->SetQuery("SELECT `company` FROM `#@__home_store` WHERE `id` = ".$results[0]["company"]);
