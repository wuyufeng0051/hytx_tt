 ...
 * 家居资讯
 *
 * @version        $Id: homeNews.php 2016-6-19 下午19:03:10 $
...
if($dopost != ""){
	$templates = "homeNewsAdd.html";

	//js
	$jsFile = array(
		'ui/jquery.dragsort-0.5.1.min.js',
		'publicUpload.js',
		'admin/home/homeNewsAdd.js'
	);
	...
	$templates = "homeNews.html";

	//js
	$jsFile = array(
		'ui/bootstrap.min.js',
		'ui/jquery-ui-selectable.js',
		'admin/home/homeNews.js'
	);
	$huoniaoTag->assign('jsFile', includeFile('js', $jsFile));
}
...
if($dopost == "getList"){
	...
	if(count($results) > 0){
		...
		if(count($list) > 0){
			echo '{"state": 100, "info": '.json_encode("获取成功").', "pageInfo": {"totalPage": '.$totalPage.', "totalCount": '.$totalCount.'}, "homeNewsList": '.json_encode($list).'}';
		}else{
...
if(file_exists($tpl."/".$templates)){
	...
	$huoniaoTag->assign('typeListArr', json_encode($dsql->getTypeList(0, "home_news_type")));
