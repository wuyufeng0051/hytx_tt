 ...
 * 家居资讯分类
 *
 * @version        $Id: homeNewsType.php 2016-6-19 下午19:04:10 $
...
checkPurview("homeNewsType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/home";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "homeNewsType.html";
...
//修改分类
	...
	if(!testPurview("editHomeNewsType")){
...
//删除分类
	...
	if(!testPurview("delHomeNewsType")){
		die('{"state": 200, "info": '.json_encode('对不起，您无权使用此功能！').'}');
	}
	if($id == "") die;
...
//更新信息分类
	...
	if(!testPurview("addHomeNewsType")){
		die('{"state": 200, "info": '.json_encode('对不起，您无权使用此功能！').'}');
	}
