 ...
 * 管理房产地区
 *
 * @version        $Id: houseAddr.php 2014-1-7 下午22:29:11 $
...
checkPurview("houseAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/house";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "houseAddr.html";
