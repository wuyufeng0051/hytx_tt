 ...
 * 管理活动区域
 *
 * @version        $Id: huodongAddr.php 2016-12-22 下午14:36:25 $
...
checkPurview("huodongAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/huodong";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "huodongAddr.html";
