 ...
 * 管理招聘地区
 *
 * @version        $Id: jobAddr.php 2014-1-7 下午22:29:11 $
 * @package        HuoNiao.Job
...
checkPurview("jobAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/job";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "jobAddr.html";
