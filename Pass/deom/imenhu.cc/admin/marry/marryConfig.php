 ...
 * 婚嫁频道配置
 *
 * @version        $Id: marryConfig.php 2014-3-14 上午11:49:02 $
...
checkPurview("marryConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/marry";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "marryConfig.html";

$action =  $action == "" ? "marry" : $action;
...
if($type != ""){
	...
	if($type == "site"){
		...
		$custom_hotel_atlasMax = (int)$hotel_atlasMax;
		$custom_sy_atlasMax    = (int)$sy_atlasMax;
		$custom_hq_atlasMax    = (int)$hq_atlasMax;
		$custom_sy_zp_atlasMax = (int)$sy_zp_atlasMax;
		$custom_sy_al_atlasMax = (int)$sy_al_atlasMax;
		$custom_hq_zp_atlasMax = (int)$hq_zp_atlasMax;
	...
	$customInc .= "\$custom_hotel_atlasMax = ".$custom_hotel_atlasMax.";\r\n";
	$customInc .= "\$custom_sy_atlasMax = ".$custom_sy_atlasMax.";\r\n";
	$customInc .= "\$custom_hq_atlasMax = ".$custom_hq_atlasMax.";\r\n";
	$customInc .= "\$custom_sy_zp_atlasMax = ".$custom_sy_zp_atlasMax.";\r\n";
	$customInc .= "\$custom_sy_al_atlasMax = ".$custom_sy_al_atlasMax.";\r\n";
	$customInc .= "\$custom_hq_zp_atlasMax = ".$custom_hq_zp_atlasMax.";\r\n";
	//模板风格
...
if(file_exists($tpl."/".$templates)){
	...
	$huoniaoTag->assign('hotel_atlasMax', $custom_hotel_atlasMax);
	$huoniaoTag->assign('sy_atlasMax', $custom_sy_atlasMax);
	$huoniaoTag->assign('hq_atlasMax', $custom_hq_atlasMax);
	$huoniaoTag->assign('sy_zp_atlasMax', $custom_sy_zp_atlasMax);
	$huoniaoTag->assign('sy_al_atlasMax', $custom_sy_al_atlasMax);
	$huoniaoTag->assign('hq_zp_atlasMax', $custom_hq_zp_atlasMax);
