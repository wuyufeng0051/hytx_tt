 ...
 * 婚尚帮助
 *
 * @version        $Id: marryHelp.php 2014-8-4 下午20:53:19 $
...
if($dopost != ""){
	$templates = "marryHelpAdd.html";

	//js
	$jsFile = array(
		'ui/bootstrap.min.js',
		'admin/marry/marryHelpAdd.js'
	);
	$huoniaoTag->assign('jsFile', includeFile('js', $jsFile));
}else{
	$templates = "marryHelpList.html";

	//js
	$jsFile = array(
		'ui/bootstrap.min.js',
		'ui/jquery-ui-selectable.js',
		'admin/marry/marryHelpList.js'
	);
	$huoniaoTag->assign('jsFile', includeFile('js', $jsFile));
}
...
if($dopost == "getList"){
	...
	if(count($results) > 0){
		...
		if(count($list) > 0){
			echo '{"state": 100, "info": '.json_encode("获取成功").', "pageInfo": {"totalPage": '.$totalPage.', "totalCount": '.$totalCount.'}, "marryHelpList": '.json_encode($list).'}';
		}else{
