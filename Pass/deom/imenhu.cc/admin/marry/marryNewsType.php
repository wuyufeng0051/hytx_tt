 ...
 * 婚尚资讯分类
 *
 * @version        $Id: marryNewsType.php 2014-8-4 下午20:51:41 $
...
checkPurview("marryNewsType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/marry";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "marryNewsType.html";
