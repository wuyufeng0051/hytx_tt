 ...
 * 电子报频道配置
 *
 * @version        $Id: paperConfig.php 2014-3-14 上午11:49:02 $
...
checkPurview("paperConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/paper";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "paperConfig.html";

$action =  $action == "" ? "paper" : $action;
