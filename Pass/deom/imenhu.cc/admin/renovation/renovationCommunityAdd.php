...
if($dopost == "save" && $submit == "提交"){
	//保存到表
	$archives = $dsql->SetQuery("INSERT INTO `#@__".$tab."` (`title`, `litpic`, `addrid`, `address`, `lnglat`, `price`, `protype`, `tese`, `zhuangxiu`, `kfs`, `buildage`, `opendate`, `buildtype`, `huanxian`, `rongji`, `green`, `proprice`, `property`, `buildarea`, `planarea`, `planhouse`, `note`, `config`, `pics`, `click`, `weight`, `state`, `pubdate`) VALUES ('$title', '$litpic', '$addrid', '$address', '$lnglat', '$price', '$protype', '$tese', '$zhuangxiu', '$kfs', '$buildage', '$opendate', '$buildtype', '$huanxian', '$rongji', '$green', '$proprice', '$property', '$buildarea', '$planarea', '$planhouse', '$note', '$config', '$imglist', '$click', '$weight', '$state', '".GetMkTime(time())."')");
