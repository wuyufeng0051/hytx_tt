 ...
 * 外卖问题分类
 *
 * @version        $Id: waimaiNewsType.php 2014-10-22 下午21:03:14 $
...
checkPurview("waimaiNewsType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/waimai";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "waimaiNewsType.html";
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'admin/waimai/waimaiNewsType.js'
	);
