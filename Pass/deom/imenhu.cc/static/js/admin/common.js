			...
			huoniao.operaJson("../inc/json.php?action=getMemberInfo", "id="+id, function(data){
				...
				if(data){
					...
					$.dialog({
						...
						fixed: false,
						title: "会员信息",
						content: '<table width="100%"border="0"cellspacing="1"cellpadding="5" style="line-height:2em;"><tr><td width="100"valign="top"><img src="'+cfg_attachment+data[0]["photo"]+'&type=small"width="100"/></td><td width="80"align="right"valign="top">会员名：<br />昵称：<br />性别：<br />邮箱：<br />电话：<br />QQ：<br />生日：<br />注册时间：<br />注册IP：</td><td valign="top">'+data[0]["username"]+'<br />'+data[0]["nickname"]+'<br />'+(data[0]["sex"] == 0 ? "女" : "男")+'<br />'+data[0]["email"]+(data[0]["emailCheck"] == 0 ? "&nbsp;<font color='#f00'>[未验证]</font>" : "&nbsp;<font color='green'>[已验证]</font>")+'<br />'+data[0]["phone"]+(data[0]["phoneCheck"] == 0 ? "&nbsp;<font color='#f00'>[未验证]</font>" : "&nbsp;<font color='green'>[已验证]</font>")+'<br />'+data[0]["qq"]+'<br />'+huoniao.transTimes(data[0]["birthday"], 2)+'<br />'+huoniao.transTimes(data[0]["regtime"], 2)+'<br />'+data[0]["regip"]+'</td></tr></table>',
						width: 500,
						okVal: "修改会员信息",
						ok: function(){
