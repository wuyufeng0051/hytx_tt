...
$(function(){
	...
	$("#type").change(function(){
		...
		if(val != ""){
			huoniao.operaJson("furnitureProductAdd.php?dopost=getBrand", "id="+val, function(data){
	...
	$("#btnSubmit").bind("click", function(event){
		...
		//异步提交
		huoniao.operaJson("furnitureProductAdd.php", $("#editform").serialize() + "&submit="+encodeURI("提交"), function(data){
			if(data.state == 100){
				if($("#dopost").val() == "save"){
