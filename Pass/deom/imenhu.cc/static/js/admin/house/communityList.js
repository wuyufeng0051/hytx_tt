	...
	huoniao.operaJson("communityList.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < communityList.length; i++){
				...
				list.push('  <td class="row35 left">'+img+'<span><a href="'+communityList[i].url+'" target="_blank">'+communityList[i].title+'</a></span></td>');
				list.push('  <td class="row10"><a href="javascript:;" data-id="'+communityList[i].addrid+'" class="addr">'+communityList[i].addr+'</a></td>');
