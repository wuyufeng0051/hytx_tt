			...
			for(var i = 0; i < l; i++){
				(function(){
					...
					if(jsonArray["parentid"] == 0){
						...
						typeList.push('  <div class="row45 left"><input type="text" data-id="'+jsonArray["id"]+'" value="'+jsonArray["typename"]+'">'+addType+'</div>');
						typeList.push('  <div class="row17 right"><a href="javascript:;" class="edit" title="编辑">编辑</a></div>');
					}else{
						typeList.push('  <div class="row3"></div>');
						typeList.push('  <div class="row45 left"><span class="plus-icon" style="margin-left:'+cl+'px;"></span><input type="text" data-id="'+jsonArray["id"]+'" value="'+jsonArray["typename"]+'">'+addType+'</div>');
						typeList.push('  <div class="row17 right"><a href="javascript:;" class="edit" title="编辑">编辑</a></div>');
					}
