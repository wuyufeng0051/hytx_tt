...
$(function(){
	...
	thumbnail = function() {
		new SWFUpload({
			upload_url: "/include/upload.inc.php?mod=job&type=logo",
	...
	$("#btnSubmit").bind("click", function(event){
		...
		//异步提交
		huoniao.operaJson("jobCompanyAdd.php", $("#editform").serialize() + "&pics="+picslist.join("###")+"&submit="+encodeURI("提交"), function(data){
			if(data.state == 100){
				if($("#dopost").val() == "save"){
