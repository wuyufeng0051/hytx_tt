	...
	huoniao.operaJson("moneyLogs.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < list.length; i++){
				...
				listArr.push('  <td class="row15 left"><a href="javascript:;" data-id="'+list[i].userid+'" class="userinfo">'+list[i].username+'</a></td>');
				...
				listArr.push('  <td class="row20 left">'+amount+'</td>');
				listArr.push('  <td class="row17 left">'+list[i].date+'</td>');
				listArr.push('  <td class="row15 left"><a href="javascript:;" title="删除" class="del">删除</a></td>');
			}
