	...
	huoniao.operaJson("paperCompany.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < paperCompany.length; i++){
				...
				list.push('  <td class="row40 left"><img src="'+cfg_attachment+paperCompany[i].litpic+'" width="100" />&nbsp;&nbsp;<a href="/article.php?id='+paperCompany[i].id+'" target="_blank">'+paperCompany[i].title+'</a></td>');
				list.push('  <td class="row10 left">'+paperCompany[i].weight+'</td>');
