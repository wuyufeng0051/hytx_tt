	...
	huoniao.operaJson("shopBrand.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < shopBrandList.length; i++){
				...
				list.push('  <td class="row40 left"><img width="100" src="'+cfg_attachment+shopBrandList[i].logo+'&type=large" />&nbsp;'+shopBrandList[i].title+'</td>');
				list.push('  <td class="row15"><a href="javascript:;" data-id="'+shopBrandList[i].typeid+'" class="type">'+shopBrandList[i].type+'</a></td>');
				list.push('  <td class="row5">'+shopBrandList[i].weight+'</td>');
				list.push('  <td class="row12">'+shopBrandList[i].pubdate+'</td>');
				list.push('  <td class="row25"><a data-id="'+shopBrandList[i].id+'" data-title="'+shopBrandList[i].title+'" href="shopBrand.php?dopost=Edit&id='+shopBrandList[i].id+'" title="修改" class="edit">修改</a><a href="javascript:;" title="删除" class="del">删除</a></td>');
				list.push('</tr>');
			}
