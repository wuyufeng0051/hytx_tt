$(function(){
	...
	$("#check").bind("click", function(){
		var smsPopup = $.dialog({
			fixed: true,
			title: "测试短信帐号",
			content: '<form class="quick-editForm" style="padding:30px 0;"><dl class="clearfix"><dt>手机号码：</dt><dd><input class="input-xlarge" type="text" name="mobile" id="mobile" value=""></dd></dl></form>',
			width: 460,
			ok: function(){
				//提交
