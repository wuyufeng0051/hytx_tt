 ...
 * 房产资讯分类
 *
 * @version        $Id: houseNewsType.php 2013-11-30 下午23:49:25 $
...
checkPurview("houseNewsType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/house";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "houseNewsType.html";
