 ...
 * 招聘资讯分类
 *
 * @version        $Id: jobNewsType.php 2013-11-30 下午23:49:25 $
 * @package        HuoNiao.Job
...
checkPurview("jobNewsType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/job";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "jobNewsType.html";
