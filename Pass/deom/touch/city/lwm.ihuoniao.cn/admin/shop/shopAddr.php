 ...
 * 管理商城地区
 *
 * @version        $Id: shopAddr.php 2013-11-6 上午11:06:10 $
...
checkPurview("shopAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/shop";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "shopAddr.html";
