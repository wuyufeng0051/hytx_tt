...
if(isset($set_modules) && $set_modules == TRUE){
    ...
    /* 回调地址 */
    $login[$i]['callback'] = "http://".$cfg_basehost."/api/login.php?action=back&type=baidu";
    ...
    $login[$i]['config'] = array(
		array('title' => 'clientId',     'name' => 'clientId',     'type' => 'text'),
		array('title' => 'clientSecret', 'name' => 'clientSecret', 'type' => 'text')
    );
