...
.toolbar a {border-right:1px solid #d2d2d2; float:left; height:100%; width:64px; height:100%; background-image:url(http://api.map.baidu.com/library/DrawingManager/1.4/src/bg_drawing_tool.png); cursor:pointer;}
...
//tencent
	...
	global $cfg_map_qq;
	$dituType = 'qq';
	$jsApiFile = 'http://map.qq.com/api/js?key='.$cfg_map_qq.'&libraries=drawing';
?>
<style type="text/css">
html, body {height:100%;margin:0px;padding:0px}
#map {height:100%;}
...
?>
<script src="<?php $cfg_basedir ?>/static/js/ui/map/<?php echo $dituType; ?>/shape.js?v=9"></script>
