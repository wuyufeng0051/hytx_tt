			...
			for(var i = 0; i < l; i++){
				(function(){
					...
					if(jsonArray["parentid"] == 0){
						...
						typeList.push('  <div class="row60 left"><input'+style+' type="text" data-id="'+jsonArray["id"]+'" value="'+jsonArray["typename"]+'">'+hot+addType+'</div>');
					}else{
						typeList.push('  <div class="row3"></div>');
						typeList.push('  <div class="row60 left"><span class="plus-icon" style="margin-left:'+cl+'px;"></span><input'+style+' type="text" data-id="'+jsonArray["id"]+'" value="'+jsonArray["typename"]+'">'+hot+addType+'</div>');
					}
