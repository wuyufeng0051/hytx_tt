	...
	function getCommentList(list){
		...
		for(var i = 0; i < list.length; i++){
			...
			if(lower != null) {
				...
				html.push('<dt><img src="'+ cmnt[m]['photo'] + '" onerror="javascript:this.src=\''+staticPath+'images/noPhoto_40.jpg\';" class="cmnt_user_head" alt=""></dt>');
				html.push('<dd>');
				html.push('<p class="cmnt_nick">');
				html.push('<span class="cmnt_user_name">' + cmnt[m]['nickname'] + '</span>');
  			...
  			html.push('<dt><img src="' + photo + '" onerror="javascript:this.src=\''+staticPath+'images/noPhoto_40.jpg\';" class="cmnt_user_head" alt=""></dt>');
  			html.push('<dd>');
  			html.push('<p class="cmnt_nick"><span class="cmnt_user_name">' + nickname + '</span><span class="cmnt_addres">' + ipaddr + '</span></p>');
