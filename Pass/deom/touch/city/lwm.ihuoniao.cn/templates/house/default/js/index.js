$(function(){
					...
					if(data && data.state == 100 && data.info.list.length > 0){
						...
						if(id == "groupbuy"){
							...
							for(var i = 0; i < list.length; i++){
								...
								if(list[i].rec == 1){
									...
									html.push('<a href="'+list[i].url+'" target="_blank" class="pic"><img src="'+cfg_staticPath+'images/blank.gif" data-url="'+list[i].litpic+'"></a>');
									...
									if(price == 0){
										...
										price = price + (list[i].ptype == 1 ? "元/平米" : "万元/套");
									}

									html.push('<h5><a href="'+list[i].url+'" target="_blank">'+list[i].title+'</a>[<a href="'+list[i].url+'" target="_blank">'+list[i].addr[0]+'</a>]</h5>');
						...
						for(var i = 0; i < list.length; i++){
							...
							if(id == "product"){
								...
								html.push('<div class="info">');
								html.push('<div class="txt">'+list[i].title+'<br>&yen;'+list[i].price+'</div>');
								html.push('<div class="bg"></div>');
								html.push('</div>');
								html.push('</a>');
								html.push('</li>');
								...
								html.push('<img src="'+cfg_staticPath+'images/blank.gif" data-url="'+huoniao.changeFileSize(list[i].litpic, type)+'" alt="'+list[i].title+'" />');
								html.push('<div class="info">');
								...
								//租房
									...
									//房产
									if(action == "zuList"){
										var price = list[i].price == 0 ? "价格面议" : list[i].price + "元/月";
										price = price+'&nbsp;&nbsp;'+list[i].room+'&nbsp;&nbsp;'+list[i].rentype;

									//写字楼
									}else if(action == "xzlList"){
										var price = list[i].price == 0 ? "价格面议" : list[i].price + (type == 1 ? "万元" : "元/月");
									...
									//厂房
										...
										var price = list[i].price == 0 ? "价格面议" : list[i].price + (type == 2 ? "万元" : "元/月");
										price = price+'&nbsp;&nbsp;'+list[i].area+'㎡';
									}
								}
								...
								html.push('<div class="txt">'+title+'['+list[i].addr[0]+']<br />'+price+'</div>');
								html.push('<div class="bg"></div>');
								html.push('</div>');
								html.push('</a>');
								html.push('</li>');
	...
	var ajaxList = ["loupanList", "groupbuy", "saleList", "zuList", "commerical", "product"];
	...
	//建材产品
	cycle('#product-rec .slide', '#product-rec .prev', '#product-rec .next', null);
