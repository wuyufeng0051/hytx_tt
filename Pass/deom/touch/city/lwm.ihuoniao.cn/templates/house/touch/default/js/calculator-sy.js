$(function() {
    ...
    function compute_result() {
        ...
        var first_pay = getMonthMoney2(lilv, daikuan_total, month, 0)
        var average_pay_bj = Math.round(first_pay * 100) / 100;
        ...
        for (j = 0; j < month; j++) {
            ...
            poputData += '<li><span style="width: ' + (huankuan / average_pay_bj * 100) + '%;">第' + (j + 1) + '期<em>' + huankuan + '元</em></span></li>';
        }
