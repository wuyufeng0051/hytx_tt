  ...
  //选择规格
    ...
    ,logistic: function(){
      ...
      if(val == 0){
		...
		//库存
		,inventory: function(){
			return this.regexp($("#inventory"), "[0-9]\\d*", "输入错误，请填写正确的数字！");
		}

		//购买限制
		,limit: function(){
			return this.regexp($("#limit"), "[0-9]\\d*", "输入错误，请填写正确的数字！");
		}
