			...
			success: function(data){
				...
				if(data.state == 100){
					...
					for(var i = 0; i < info.length; i++){
						content.push('<li data-id="'+info[i].id+'"><i class="icon-move" title="拖拽排序"></i><input type="text" name="name[]" value="'+info[i].name+'" /><a href="javascript:;" class="icon-trash" title="删除"></a></li>');
					}
				}
