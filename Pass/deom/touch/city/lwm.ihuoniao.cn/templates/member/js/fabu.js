var titleRegex       = '.{2,50}', titleErrTip = '输入错误，请正确填写，2-50个字！';
var writerRegex       = '.{2,20}', writerErrTip = '输入错误，请正确填写，2-20个字！';
var sourceRegex      = '.{2,20}', sourceErrTip = '输入错误，请正确填写，2-20个字！';
var keywordsRegex    = '.{2,50}', keywordsErrTip = '输入错误，请正确填写，2-50个字！';
var descriptionRegex = '.{10,200}', descriptionErrTip = '输入错误，请正确填写，10-200个字！';
