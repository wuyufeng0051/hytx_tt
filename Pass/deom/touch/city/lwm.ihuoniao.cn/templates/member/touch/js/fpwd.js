$(function(){
	...
	// 切换
	$('.type-tab .type-box').click(function(){
		var index = $(this).index();
		$('.type-box').eq(index).addClass('active').siblings().removeClass('active');
		$('.form-box-item').eq(index).removeClass('dn').siblings('.form-box-item').addClass('dn');
	})
