$(function(){
	  ...
	  //实名认证
		$("#submit").bind("click", function(){
			var realname = $("#realname"), idcard = $("#idcard"), front = '', back = '', btn = $(this);
			if(realname.val() == ""){
				showMsg("请输入真实姓名");
				realname.focus();
				return "false";
			...
			var imglist = [], imgli = $("#litpic li.item");
			...
			var param = "realname="+realname.val()+"&idcard="+idcard.val()+"&front="+front+"&back="+back;
    		modifyFun(btn,'确定提交','certify',param);
