<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-05-25 10:26:07
         compiled from "D:\ServerWwwroot\www.lwm.com\admin\templates\shop\shopOrder.html" */ ?>
<?php /*%%SmartyHeaderCode:23480592640bf07dda7-28764495%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ff08685630373dd3b4162031982845a3d6bd978e' => 
    array (
      0 => 'D:\\ServerWwwroot\\www.lwm.com\\admin\\templates\\shop\\shopOrder.html',
      1 => 1494490291,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '23480592640bf07dda7-28764495',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_592640bf0acbb9_83725098',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_592640bf0acbb9_83725098')) {function content_592640bf0acbb9_83725098($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
  ...
  <div class="f-left">
    ...
    <div class="btn-group" id="stateBtn">
      ...
      <ul class="dropdown-menu">
        ...
        <li><a href="javascript:;" data-id="0">未付款(<span class="state0"></span>)</a></li>
        <li><a href="javascript:;" data-id="1">已付款(<span class="state1"></span>)</a></li>
        <li><a href="javascript:;" data-id="3">交易成功(<span class="state3"></span>)</a></li>
        <li><a href="javascript:;" data-id="4">退款中(<span class="state4"></span>)</a></li>
        <li><a href="javascript:;" data-id="6">已发货(<span class="state6"></span>)</a></li>
        <li><a href="javascript:;" data-id="7">退款成功(<span class="state7"></span>)</a></li>
        <li><a href="javascript:;" data-id="10">关闭(<span class="state10"></span>)</a></li>
      </ul>
    </div>
  </div>
  <div class="f-right">
...
<ul class="thead t100 clearfix">
  <li class="row3">&nbsp;</li>
  <li class="row12 left">订单号</li>
  <li class="row10 left">买家</li>
  <li class="row17 left">商家</li>
  <li class="row8 left">订单金额</li>
  <li class="row15 left">下单时间</li>
  <li class="row15 left">支付方式</li>
