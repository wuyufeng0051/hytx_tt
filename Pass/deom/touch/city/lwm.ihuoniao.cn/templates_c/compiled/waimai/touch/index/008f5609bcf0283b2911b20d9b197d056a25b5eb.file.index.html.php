<?php /* Smarty version Smarty-3.1.21-dev, created on 2017-06-29 17:25:13
         compiled from "D:\wwwroot\deom\touch\lwm.ihuoniao.cn\templates\courier\index.html" */ ?>
<?php /*%%SmartyHeaderCode:1477595382786836a9-64214430%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1477595382786836a9-64214430',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_595382786d95b5_29274658',
  'variables' => 
  array (
    'cfg_staticPath' => 0,
    'courier_state' => 0,
...
<?php if ($_valid && !is_callable('content_595382786d95b5_29274658')) {function content_595382786d95b5_29274658($_smarty_tpl) {?><!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
...
<div class="mode01">
	...
	<div class="stateNow stateNow01" data-type="1">
		...
		<a data-page="1" data-totalpage="1" data-action="robbed" href="/?service=waimai&do=courier&state=3"<?php if ($_smarty_tpl->tpl_vars['state']->value=="3") {?> class="daiQiang"<?php }?>>待抢</a>
		<a data-page="1" data-totalpage="1" data-action="distribution" href="/?service=waimai&do=courier&state=4,5"<?php if ($_smarty_tpl->tpl_vars['state']->value=="4,5") {?> class="daiQiang"<?php }?>>配送</a>
		<a data-page="1" data-totalpage="1"  data-action="succeed" href="/?service=waimai&do=courier&state=1"<?php if ($_smarty_tpl->tpl_vars['state']->value=="1") {?> class="daiQiang"<?php }?>>成功</a>
		<a data-page="1" data-totalpage="1" data-action="Failure" href="/?service=waimai&do=courier&state=7"<?php if ($_smarty_tpl->tpl_vars['state']->value=="7") {?> class="daiQiang"<?php }?>>失败</a>
	</div>
	<div class="xuanXiang">
		<!-- 待抢 -->
