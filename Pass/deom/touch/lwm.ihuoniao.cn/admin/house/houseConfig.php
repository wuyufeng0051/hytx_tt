 ...
 * 房产频道配置
 *
 * @version        $Id: houseConfig.php 2013-7-7 上午10:33:36 $
...
checkPurview("houseConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/house";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "houseConfig.html";

$action =  $action == "" ? "house" : $action;
...
if($type != ""){
	...
	if($type == "site"){
		...
		$custom_la_atlasMax    = (int)$la_atlasMax;
		$custom_ll_atlasMax    = (int)$ll_atlasMax;
		$custom_ca_atlasMax    = (int)$ca_atlasMax;
		$custom_houseSale_atlasMax  = (int)$houseSale_atlasMax;
		$custom_houseZu_atlasMax    = (int)$houseZu_atlasMax;
		$custom_houseXzl_atlasMax   = (int)$houseXzl_atlasMax;
		$custom_houseSp_atlasMax    = (int)$houseSp_atlasMax;
		$custom_houseCf_atlasMax    = (int)$houseCf_atlasMax;
	...
	$customInc .= "\$custom_la_atlasMax = ".$custom_la_atlasMax.";\r\n";
	$customInc .= "\$custom_ll_atlasMax = ".$custom_ll_atlasMax.";\r\n";
	$customInc .= "\$custom_ca_atlasMax = ".$custom_ca_atlasMax.";\r\n";
	$customInc .= "\$custom_houseSale_atlasMax = ".$custom_houseSale_atlasMax.";\r\n";
	$customInc .= "\$custom_houseZu_atlasMax = ".$custom_houseZu_atlasMax.";\r\n";
	$customInc .= "\$custom_houseXzl_atlasMax = ".$custom_houseXzl_atlasMax.";\r\n";
	$customInc .= "\$custom_houseSp_atlasMax = ".$custom_houseSp_atlasMax.";\r\n";
	$customInc .= "\$custom_houseCf_atlasMax = ".$custom_houseCf_atlasMax.";\r\n";
...
if(file_exists($tpl."/".$templates)){
	...
	$huoniaoTag->assign('la_atlasMax', $custom_la_atlasMax);
	$huoniaoTag->assign('ll_atlasMax', $custom_ll_atlasMax);
	$huoniaoTag->assign('ca_atlasMax', $custom_ca_atlasMax);
	$huoniaoTag->assign('houseSale_atlasMax', $custom_houseSale_atlasMax);
	$huoniaoTag->assign('houseZu_atlasMax', $custom_houseZu_atlasMax);
	$huoniaoTag->assign('houseXzl_atlasMax', $custom_houseXzl_atlasMax);
	$huoniaoTag->assign('houseSp_atlasMax', $custom_houseSp_atlasMax);
	$huoniaoTag->assign('houseCf_atlasMax', $custom_houseCf_atlasMax);
