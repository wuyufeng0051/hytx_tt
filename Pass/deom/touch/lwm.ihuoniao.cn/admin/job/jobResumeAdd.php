...
if($dopost == "save" && $submit == "提交"){
	//保存到表
	$archives = $dsql->SetQuery("INSERT INTO `#@__".$tab."` (`userid`, `name`, `sex`, `nature`, `type`, `addr`, `birth`, `photo`, `home`, `address`, `phone`, `email`, `salary`, `startwork`, `evaluation`, `objective`, `workyear`, `experience`, `educational`, `college`, `graduation`, `professional`, `language`, `computer`, `education`, `state`, `click`, `weight`, `pubdate`) VALUES ('$userid', '$name', '$sex', '$nature', '$type', '$addr', '$birth', '$litpic', '$home', '$address', '$phone', '$email', '$salary', '$startwork', '$evaluation', '$objective', '$workyear', '$experience', '$educational', '$college', '$graduation', '$professional', '$language', '$computer', '$education', '$state', '$click', '$weight', '".GetMkTime(time())."')");
