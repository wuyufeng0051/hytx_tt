 ...
 * 外卖频道配置
 *
 * @version        $Id: waimaiConfig.php 2014-10-11 下午17:31:11 $
...
checkPurview("waimaiConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/waimai";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "waimaiConfig.html";

$action =  $action == "" ? "waimai" : $action;
...
if($type != ""){
	...
	$customInc .= "\$customMemberRefundswitch = ".$customMemberRefundswitch.";\r\n";
...
if(file_exists($tpl."/".$templates)){
	...
	//会员退款权限开关-单选
	$huoniaoTag->assign('memberRefundswitch', array('0', '1'));
	$huoniaoTag->assign('memberRefundswitchNames',array('允许','禁用'));
	$huoniaoTag->assign('memberRefundswitchChecked', $customMemberRefundswitch);
