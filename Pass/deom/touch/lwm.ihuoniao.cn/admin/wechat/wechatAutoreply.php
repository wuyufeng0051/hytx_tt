...
//更新
	...
	$configFile .= "\$cfg_wechatName = '".$cfg_wechatName."';\r\n";
	$configFile .= "\$cfg_wechatCode = '".$cfg_wechatCode."';\r\n";
	$configFile .= "\$cfg_wechatQr = '".$cfg_wechatQr."';\r\n";
...
if(file_exists($tpl."/".$templates)){
	...
	$huoniaoTag->assign('wechatSubscribe', $cfg_wechatSubscribe);
