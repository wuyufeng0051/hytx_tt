...
if(isset($set_modules) && $set_modules == TRUE){
    ...
    /* 回调地址 */
    $login[$i]['callback'] = "http://".$cfg_basehost."/api/login.php?action=back&type=qq";
...
class Loginqq {
	...
	function appback($data, $return){
        ...
        //获取openid
        $graph_url = "https://graph.qq.com/oauth2.0/me?access_token=".$return["access_token"]."&unionid=1";
