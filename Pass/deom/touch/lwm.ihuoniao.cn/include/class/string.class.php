 ...
 * @return    string
 */
function AnalyseHtmlBody($body, &$description, &$keywords){
    global $title, $cfg_soft_lang;
...
function GetDDImgFromBody(&$body){
    ...
    if(count($img_array) > 0){
        ...
        if(preg_match("#attachment.php#", $picname)) $litpic = str_replace("/include/attachment.php?f=", "", $picname);
        else $litpic = $picname;
