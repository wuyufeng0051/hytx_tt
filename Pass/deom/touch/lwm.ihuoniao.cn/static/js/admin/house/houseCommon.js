	...
	huoniao.operaJson("houseCommon.php?dopost=getList&action="+action, data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < commonList.length; i++){
				...
				list.push('  <td class="row35 title left">信息：<a href="javascript:;" class="article" data-id='+commonList[i].articleId+'">'+commonList[i].articleTitle+'</a><br />内容：'+commonList[i].commonContent+'</td>');
