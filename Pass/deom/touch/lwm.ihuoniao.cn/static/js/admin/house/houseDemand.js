$(function(){
	...
	$("#searchBtn").bind("click", function(){
		...
		$("#sAction").html($("#actionBtn").attr("data-id"));
	...
	huoniao.operaJson("houseDemand.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < houseDemandList.length; i++){
				...
				list.push('  <td class="row20 left"><a href="/article.php?id='+houseDemandList[i].id+'" target="_blank">'+houseDemandList[i].title+'</a></td>');
