	...
	huoniao.operaJson("productList.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < productList.length; i++){
				...
				list.push('  <td class="row25 left"><img src="'+cfg_attachment+productList[i].litpic+'" class="litpic" /><span><a href="'+productList[i].url+'" target="_blank">'+productList[i].title+'</a>'+flag+'</span></td>');
				...
				list.push('  <td class="row15 left">'+store+'</td>');
