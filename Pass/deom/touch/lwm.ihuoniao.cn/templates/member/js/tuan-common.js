$(function(){
	...
	var star_text= {
		...
		score3: {r0:{text:''},r1:{text:'环境非常差，我都看不下去了'},r2:{text:'环境有点差，需要好好改善'},r3:{text:'环境一般，勉强可以接受啦'},r4:{text:'环境还不错，希望越来越好'},r5:{text:'环境超级好，好喜欢'}}
	};
		...
		$.ajax({
			...
			success: function (data) {
				if(data && data.state == 100){
					alert("评价成功！");
					t.attr("disabled", false).html("修改评价");
				}else{
					alert(data.info);
					t.attr("disabled", false).html("重新发表");
				}
			},
			error: function(){
				alert("网络错误，请重试！");
