       ...
       if(data.state == 101){
         ...
         if(list.length > 0){
           ...
           for(var i = 0; i < list.length; i++){
             ...
             var apa = [];
             if(top == 1){
               html.push('<span style="background: #66a3ff; color:#fff; padding: 0 .1rem; margin-right: .2rem; font-size: .24rem;">置顶</span>');
             }
             if(jinghua == 1){
               html.push('<span style="background: #f66; color:#fff; padding: 0 .1rem; font-size: .24rem;">精华</span>');
             }
             var arcrank = "";
             if(list[i].state == "0"){
               html.push('<span style="color:#999; padding: 0 .1rem; margin-right: .2rem; font-size: .24rem; float: right;">未审核</span>');
             }else if(list[i].state == "1"){
               html.push('<span style="color:#ff6800; padding: 0 .1rem; font-size: .24rem; float: right;">已审核</span>');
             }else if(list[i].state == "2"){
               html.push('<span style="color:#f00; padding: 0 .1rem; font-size: .24rem; float: right;">审核拒绝</span>');
             }
             ...
             html.push('<dd class="item-area"><em>分类：'+typename+'</em></dd>');
             html.push('<dd class="item-type-1"><em> 浏览：'+click+'次 </em><em>评论：'+reply+'条</em></dd>');
