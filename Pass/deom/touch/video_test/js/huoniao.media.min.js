...
function() {
    ...
    a.MediaPlayer = function(b, c) {
        ...
        if (!b.isInstantiated && (b.isInstantiated = !0, d.media = b, f = d.media.tagName.toLowerCase(), /audio|video/.test(f))) {
            ...
            d.options.nativeControls || a.features.isVendorControls ? d.media.setAttribute("controls", "controls") : (i = d.media.getAttribute("src"), i = "" === i ? null: i, j(d.media, d.options, i) ? (d.id = "huoniaom_" + k++, a.players[d.id] = d, d.init()) : alert("不支持此" + (d.isVideo ? "视": "音") + "频"))
        }
    },
    a.MediaPlayer.prototype = {
        ...
        exitFullScreen: function() {
            ...
            e(document.documentElement, "huoniao_fullscreen"),
            ...
            e(b.fullscreenBtn, "huoniao_unfullscreen"),
            b.isFullScreen = !1
        },
        buildContainer: function() {
            ...
            a.container.innerHTML = '<div class="huoniao_wrap"></div><div class="huoniao_controls"></div>' + (a.options.mediaTitle ? '<div class="huoniao_title">' + a.options.mediaTitle + "</div>": ""),
            a.title = a.container.querySelector(".huoniao_title"),
            a.media.setAttribute("preload", a.options.preload),
            a.container.querySelector(".huoniao_wrap").appendChild(a.media),
            a.controls = a.container.querySelector(".huoniao_controls"),
        ...
        buildPlaypause: function() {
            function c(c) { (a.media.isUserClick || a.options.autoplay) && ("play" === c ? (e(b, "huoniao_play"), d(b, "huoniao_pause")) : (e(b, "huoniao_pause"), d(b, "huoniao_play")))
            }
            var a = this,
            b = document.createElement("div");
            b.className = "huoniao_playpause_btn huoniao_play",
        ...
        buildTimeline: function() {
            ...
            d.className = "huoniao_timeline",
            d.innerHTML = '<div class="huoniao_timeline_slider"><div class="huoniao_timeline_buffering" style="display:none"></div><div class="huoniao_timeline_loaded"></div><div class="huoniao_timeline_current"></div><div class="huoniao_timeline_handle"></div></div>',
        ...
        buildTime: function() {
            var a = this,
            b = document.createElement("div");
            b.className = "huoniao_time",
            b.innerHTML = '<span class="huoniao_currenttime">' + f(0, a.options) + "</span>/" + '<span class="huoniao_duration">' + f(a.options.duration, a.options) + "</span>",
            a.controls.appendChild(b),
        ...
        buildFullscreen: function() {
            ...
            b.fullscreenBtn.className = "huoniao_fullscreen_btn",
        ...
        buildDec: function() {
            ...
            e.className = "dec_play", b.container.appendChild(e), e.addEventListener("click",
            function() {
    ...
    window.huoniaomedia = function(b, c) {
