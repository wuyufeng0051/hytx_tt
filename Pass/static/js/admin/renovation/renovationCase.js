	...
	huoniao.operaJson("renovationCase.php?dopost=getList", data.join("&"), function(val){
		...
		if(val.state == "100"){
			...
			for(i; i < renovationCase.length; i++){
				...
				list.push('  <td class="row20 left"><img src="'+cfg_attachment+renovationCase[i].litpic+'&type=small" class="litpic" /><span><a href="'+renovationCase[i].url+'" target="_blank">'+renovationCase[i].title+'</a></span></td>');
				list.push('  <td class="row25 left"><a href="'+renovationCase[i].curl+'" target="_blank">'+renovationCase[i].company+'</a></td>');
				list.push('  <td class="row10 left"><a href="'+renovationCase[i].durl+'" target="_blank">'+renovationCase[i].teamname+'</a></td>');
				list.push('  <td class="row10 left">'+renovationCase[i].apartment+'</td>');
				var state = "";
