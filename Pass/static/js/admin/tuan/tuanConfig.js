$(function(){
	...
	//选择时间
	$("#subscribetime").datetimepicker({format: 'hh:ii', autoclose: true, minView: 0, language: 'ch'});
	...
	$("#btnSubmit").bind("click", function(event){
		...
		huoniao.operaJson(formAction+"?action="+action+"&type="+type+"&token="+$("#token").val(), post, function(data){
			var state = "success";
			if(data.state != 100){
				state = "error";
			}
