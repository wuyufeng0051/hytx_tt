$(function(){
	...
	$("body").append('<style>.Background_Advertising{background:url('+Background_Url+') no-repeat center 35px;z-index:-1;width:100%;position:absolute;top:0;left:0;right:0;z-index:-2;}#Background_closed{background:url('+templets_skin+'images/close.png) no-repeat;width:50px;height:22px;padding:0;position:absolute;right:0px;bottom:35px;cursor:pointer;display:block;z-index:2;top:20px;}.FestivalAD_link{position:absolute;top:35px;left:50%;height:'+FestivalAD_hdeight +'px;}.FestivalAD_link a{display:block;width:100%;height:100%;}#Background_closed:hover{background-image:url('+templets_skin+'images/close_hover_03.png)}.WthiteBox_Left{position:absolute;left:50%;background:#fff;z-index:-1;}</style><div class="Background_Advertising"></div><div class="FestivalAD_link"><a href="'+Background_Href+'"></a><div id="Background_closed"></div></div><div class="WthiteBox_Left"></div>')
