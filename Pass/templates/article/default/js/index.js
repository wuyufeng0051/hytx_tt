						...
						for(var i = 0; i < list.length; i++){
							...
							if(list[i].group_img){
								...
								for (var g = 0; g < list[i].group_img.length; g++) {
									item.push('<li><a href="'+url+'"><img onerror="this.src=\''+defaultPic+'\'" src="'+huoniao.changeFileSize(list[i].group_img[g].path, "small")+'" /></a></li>');
								};
								item.push('</ul>');
								...
								if(litpic != ""){
									item.push('<a href="'+url+'" class="pic"><img onerror="this.src=\''+defaultPic+'\'" src="'+huoniao.changeFileSize(litpic, "small")+'" alt="'+title+'"></a>');
								}
								item.push('<h3><a href="'+url+'">'+title+'</a></h3>');
