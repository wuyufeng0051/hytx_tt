			...
			var handlerPopup = function (captchaObj) {
		        ...
		        if (index == 0) {
		            if (!verifyInput($("#phone"))) {
		            	...
		            	t.addClass("disabled").text(langData['siteConfig'][23][99]+"...");
								...
								$.ajax({
									...
									success: function (data) {
										...
										var dataArr = data.split("|");
											...
											t.attr("disabled", false).val(langData['siteConfig'][6][118]);
    	...
    	$.ajax({
			...
			success: function (data) {
				...
				//获取失败
					...
					if(t.hasClass("submit")){
						t.removeClass("disabled").text(langData['siteConfig'][6][32]);
					}else{
