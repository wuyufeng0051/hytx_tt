$(function(){
    ...
    $.ajax({
      ...
      success: function (data) {
        ...
        if(data && data.state == 100){
          t.addClass('disabled').html(langData['siteConfig'][6][55]+'(<em class="count">60</em>s)')
          count = t.find('.count');
  ...
  function upload(t, width, height){
    ...
    fileupload.text(langData['siteConfig'][6][177]+'...');
    ...
    $.ajaxFileUpload({
      ...
      success: function(m, l) {
        if (m.state == "SUCCESS") {
          ...
          fileupload.text(langData['siteConfig'][6][59]);
          obj.find(".error").hide();
      ...
      error: function() {
        ...
        obj.closest("dl").find(".error").text(langData['siteConfig'][20][183]).show();
      }
    });
