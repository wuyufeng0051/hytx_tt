$(function(){
	...
	$("#submit").bind("click", function(event){
		...
		//验证描述
		var noteRegex = '.{10,500}', noteErrTip = langData['siteConfig'][20][522];
		...
		//验证验证码
		if($.trim(vdimgck.val()) == ""){
			vdimgck.siblings(".tip-inline").removeClass().addClass("tip-inline error").html("<s></s>"+langData['siteConfig'][20][176]);
