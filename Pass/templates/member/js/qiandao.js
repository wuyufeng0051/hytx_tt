    ...
    var qiandao = function(t){
      ...
      $.ajax({
          ...
          $('.ClickSign, .today').removeClass('disabled');
            ...
            $('.QianBox .SuccessDay').html(langData['siteConfig'][22][118].replace('1', data.info.zongqian));
...
var calUtil = {
  ...
  drawCal : function(iYear,iMonth ,signList ,RetroList, SpecialList) {
   ...
   htmls.push("<tr>");
   htmls.push("<th>" + langData['siteConfig'][14][10] + "</th>");
   htmls.push("<th>" + langData['siteConfig'][14][4] + "</th>");
   htmls.push("<th>" + langData['siteConfig'][14][5] + "</th>");
   htmls.push("<th>" + langData['siteConfig'][14][6] + "</th>");
   htmls.push("<th>" + langData['siteConfig'][14][7] + "</th>");
   htmls.push("<th>" + langData['siteConfig'][14][8] + "</th>");
   htmls.push("<th>" + langData['siteConfig'][14][9] + "</th>");
   htmls.push("</tr>");
   var d, w;
