...
function getList(is){
	...
	objId.html('<tr><td colspan="4"><p class="loading"><img src="'+staticPath+'images/ajax-loader.gif" />'+langData['siteConfig'][20][184]+'...</p></td></tr>');
	...
	$.ajax({
		...
		success: function (data) {
			if(data && data.state != 200){
				if(data.state == 101){
					objId.html("<tr><td colspan='4'><p class='loading'>"+langData['siteConfig'][20][126]+"</p></td></tr>");
				}else{
