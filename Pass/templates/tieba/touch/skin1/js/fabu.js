$(function(){
  ...
  $('.content').height($(window).height() -$('.header').height() - $('.title').height()*3 - $('.editor').height());
  ...
  function createUploader(id) {
    ...
    //删除已上传视频
  	...
  	uploader.on('uploadSuccess', function(file, response){
        ...
        if (id == "2") {
          var $li   = $('#'+file.id);
          $li.html('<video controls src="'+response.turl+'" data-val="'+response.url+'" webkit-playsinline="true" preload="auto" playsinline x5-video-player-type="h5" x5-video-player-fullscreen="true" x5-video-ignore-metadata="true"></video></div>');
  ...
  $(".header-search a").click(function(){
    ...
    $(".content").find('.inp-item').attr('contenteditable', false);
