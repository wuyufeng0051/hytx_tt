        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.state == 100){
                    ...
                    $('.le_list .loading').html(data.info+'<br><a href="'+searchurl+'">'+langData['waimai'][2][105]+'</a>');
                }

            },
            error: function(){
                $('.le_list .loading').html(langData['siteConfig'][20][227]+'<br><a href="'+searchurl+'">'+langData['waimai'][2][105]+'</a>');
            }
        })
